        ...
        <div class="bn-wrap d-wrap">
            ...
            <div class="bn-left d-item d-2">
                <div class="bn-content">
                    <p class="t-stroke t-title-xl fw-6 bn-txt-big"><?php echo $mona_home_section_banner['banner_subtitle']; ?></p>
                    <h1 class="t-title-bn mb-20"><?php echo $mona_home_section_banner['banner_title']; ?></h1>
                    <div class="bn-text mb-40">
                    ...
                    ?>
                        <a href="<?php echo (!empty($banner_button['button_url'])) ? esc_url($banner_button['button_url']) : 'javascript:;'; ?>" class="btn bg-white t-third">

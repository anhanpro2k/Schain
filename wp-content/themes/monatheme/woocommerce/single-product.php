                                    ...
                                    <ul class="sc-list">
                                        <li class="sc-item">
                                            <a href="" class="sc-link">
                                                <img src="<?php echo get_site_url(); ?>/template/assets/images/fb.svg"
                                                     alt="" rq4k2xpud="">
                                            </a>
                                        </li>
                                        <li class="sc-item">
                                            <a href="" class="sc-link">
                                                <img src="<?php echo get_site_url(); ?>/template/assets/images/yt.svg"
                                                     alt="">
                                            </a>
                                        </li>
                                        <li class="sc-item">
                                            <a href="" class="sc-link">
                                                <img src="<?php echo get_site_url(); ?>/template/assets/images/insta.svg"
                                                     alt="">
                                            </a>
                                        </li>
                                    </ul>
